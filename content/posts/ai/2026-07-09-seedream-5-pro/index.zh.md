...
draft = false
title = 'Seedream 5.0 Pro 上线：字节生图杀入 Gemini 腹地？API'
description = 'Seedream 5.0 Pro 于 2026 年 7 月 8 日上线火山方舟：1K 单张 0.3 元、2K 0.6 元，按张计费。本文核检"超过 Gemini"的真实出处，给出开通、调用、计费全流程...'
toc = true
