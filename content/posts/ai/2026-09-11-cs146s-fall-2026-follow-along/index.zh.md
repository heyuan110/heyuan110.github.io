...
answer = "没有官方视频。2025 秋季和 2026 秋季斯坦福都没有发布课堂录像。搜「cs146s 视频」排第一的那个 9 集 YouTube 播放列表来自第三方频道 AI With Ryan，是用 AI 配音把 2025 年 PPT 讲一遍的 14-16 分钟摘要，不是课堂实录。最接近官方的替代品是 2025 秋季大纲页上每节课挂的 Google Slides。"
...
answer = "官方 FAQ 给在校生的预算是每周 10-12 小时。不拿学分只跟课的话，按每周 5-6 小时、连续 10 周来规划：一个讲座主题、一篇阅读、一个动手练习，每两周试着提一次开源 PR。如果保证不了学期节奏，不如走我那篇 CS146S 自学手册里的两周速通路线。"
+++

![斯坦福 CS146S 2026 秋季课程表与免费跟课方案](cover.webp)

斯坦福 **CS146S 2026 秋季** 9 月 22 日（周二）开课，校外的人可以免费跟，但没法"看"——截至 2026 年 9 月 11 日，官方没有任何课堂录像，搜「cs146s 视频」冒出来的那个播放列表是第三方用 AI 配音复述**去年**大纲的摘要。

这个区别今年比去年重要得多：2026 秋季的大纲是一门换了半个身子的新课，10 周里 6 周是新主题，评分把 30% 压在开源贡献上，上课日也从周一/周五改成了周二/周四。

这篇是给"想实时跟课"的人的操作页：视频到底有没有、2026 秋季精确到日的课程表、哪些免费哪些只对注册学生开放、比 2025 年多了什么，以及一份把每个新主题和你手上工具对上号的逐周方案。

我刻意不在这里重讲 10 周大纲和嘉宾阵容，那些在[CS146S 课程总览](/zh/posts/ai/2026-02-24-stanford-cs146s-overview/)里；2025 秋季材料的逐讲笔记在[CS146S 自学手册](/zh/posts/ai/2026-07-02-cs146s-study-guide/)里。这一篇是叠在上面的"跟学期走"那一层。

先交一张收据，因为课程表就是这篇的全部价值。官网的 Calendar 标签是前端渲染的，现在链接指向 `#`，所以我在 9 月 11 日直接从站点的 JS bundle 里把 2026 秋季的课程表数据抠了出来。下面每个日期、每位嘉宾都来自这份数据，不是转述别人的帖子。

## 搜「cs146s 视频」到底能搜到什么

**CS146S 没有官方课堂视频，从来没有过**。一位跟完 2025 秋季课程的学生在他的[笔记仓库](https://github.com/georgestephenson/cs146s-modern-software-dev)里写得很直白："As of writing there are no video recordings of the lectures that are publicly available."（截至写作时，没有任何公开的课堂录像。）

[2026 秋季的官网](https://themodernsoftware.dev/)也没有改变这一点：课程材料和作业提交走斯坦福 Canvas，Ed 讨论区链接"只发给注册学生"。

那排在搜索结果第一的播放列表是什么？是 AI With Ryan 这个频道的 [CS146S The Modern Software Development](https://www.youtube.com/playlist?list=PLxpwjSdVZQ95OWe3QvkVEcU1f1X-6NDj9)：9 集，每集 14-16 分钟，本周累计 29,044 次播放，最后更新是 2026 年 2 月 16 日。内容是用 AI 配音把 2025 秋季的 PPT 复述一遍。

第 1 集的简介开头甚至把 CS146S 说成一门讲"可扩展系统、真实算法、高性能工程"的课——完全不是。当通勤路上预习 2025 年的主题可以，但它不是讲座，而且讲的是一份 2026 秋季已经大面积替换掉的大纲。
...
实际后果是："怎么看这门课"和"怎么跟这门课"是同一个答案：读 PPT、做阅读、跑练习，而且要在课堂进行到那一周的时候做——这样嘉宾演讲后在 X 上的讨论、讲者自己发的帖子，正好在你脑子里还热着的时候落地。这就是本文后半段的方案。

国内读者要提前知道一件事：官网和 GitHub 仓库直连都能打开，但 2025 秋季的 PPT 全部挂在 Google Slides 上，部分嘉宾资料在 Google Drive 和 Figma，这几样要自己解决访问问题。

## CS146S 2026 秋季课程表

**2026 秋季一共 10 周，每周二、周四上课，9 月 22 日到 12 月 3 日，教室 420-041**。周二是 Eric 自己的讲座，周四基本是嘉宾。

斯坦福 [2026-27 校历](https://studentservices.stanford.edu/calendar-events/academic-calendars/future-academic-calendars/stanford-academic-calendar-2026-2027)定的是 9 月 22 日开始授课，10 月 9 日选课截止，11 月 23-27 日感恩节假期，12 月 4 日最后一天上课，12 月 7-11 日考试周。课程整整跳过感恩节那一周，所以第 10 周落在 12 月 1 日。
...
两条给国内读者的时区说明。第一，官网只公布了上课日，没公布具体时间。第二，太平洋时间 11 月 1 日从 PDT（UTC-7）切到 PST（UTC-8），北京时间对应从 +15 小时变成 +16 小时——也就是说帕洛阿尔托周四下午的嘉宾演讲，在北京永远是周五早上，11 月之后再晚一小时。

反正你也进不了教室，这真正影响的是"演讲之后的材料什么时候出来"：讲者的 PPT 和推文一般 24 小时内落地，所以周五早上刷一遍大纲页和 X，是最划算的习惯。
...
**2025 秋季是一趟软件生命周期观光，2026 秋季是一本操作手册**。2025 年的大纲沿着 SDLC 走了一圈（提示、agent、IDE、终端、测试、审查、建应用、运维、展望）。2026 年的大纲默认你已经天天泡在编码 agent 里，问的是：怎么配置它、约束它、审查它、并行它、把它规模化。逐项对比如下：
...
把它读成讲师在明说：agent 写出来却从没离开过你笔记本的代码，已经不是这门课要教的能力了。

有两样东西还没跟上，开工前先知道。[作业仓库](https://github.com/mihail911/modern-software-dev-assignments)已经 3,950 star、949 fork，但最后一次 push 停在 2025 年 11 月 10 日，里面还是 2025 大纲的 `week1` 到 `week8`，没有任何 2026 的内容。

2026 秋季的大纲条目现在只有主题和嘉宾，没有阅读、没有 PPT、没有作业链接。我预期它们会像 2025 年那样一周一周补上；补上之前，2025 的仓库是唯一能跑的材料，而且大约一半能干净地对到新的周次上（后面那张表标了是哪一半）。

顺带一个数据：韩国开发者社区做了个 [CS146S 韩文版仓库](https://github.com/team-attention/stanford-cs146s-kr)，291 star。中文圈目前没有对应的东西——这门课在国内的讨论热度和它的实际关注度之间有个明显的空档。

## 免费的边界在哪：材料免费，课程不免费

**"CS146S 免费吗"要分两半回答：材料免费，课不免费**。[斯坦福课程目录](https://bulletin.stanford.edu/courses/2274401)把它列为 3-4 学分、字母评分或 Credit/No Credit，没有正式先修课（CS111、CS161 同等水平）的学生要在 9 月 27 日前提交申请。

课程 FAQ 写的是旁听"对斯坦福学生和教职工开放"。我搜了 SCPD 和 Stanford Online，都没有这门课的远程版本，所以截至今天，在职工程师没有任何远程注册的路径。
...
想不靠斯坦福学生身份听 Eric 亲自讲课，唯一的路是他在 Maven 上的付费课 [AI Software Development: From First Prompt to Production Code](https://maven.com/the-modern-software-developer/ai-course)：4 周，每周 3-4 小时，8 次直播。

它的模块列表和 2026 秋季的主题几乎逐行对应（"Build and Integrate an MCP Server or Agent Skill"、"Implementing the RePPIT Dev Loop"），说明新的斯坦福大纲和这门公开课是一起设计的。

两个我在校外解不开的疑问：页面数据里能看到的最近一期是 2026 年 6 月 22 日到 7 月 17 日，秋季班还没有挂出来；价格不走到结账页看不到。把它当成"我需要反馈和 deadline"时的选项，别当默认选项。

## 逐周跟课方案：每个新主题配一个能跑的工具

**2026 秋季官网首页点名的五个主题——MCP、agent skills、spec 驱动开发、loop engineering、软件工厂——每一个在 2026 年都已经有能直接跑的工具栈，大部分在这个博客上都有深挖文**。这个配对是没有教室也能跟下来的关键：讲座给你"为什么"和术语，工具给你练习量。
...
下面这张逐周表是值得截图的。"2025 材料"是今天就能从公开仓库和 PPT 里跑的东西；"这周做这个"是我会把整周时间押上去的那一个练习；"延伸阅读"是本站比 PPT 讲得更深的那篇。
...
注意 2025 材料在哪里断供：第 3、5、8、9、10 周目前没有公开作业。这不是等的理由。恰恰是这几周，2026 年的工具链跑在任何大纲前面最远，上面那些练习就是今年夏天一线的人已经在做的事。如果课程后来给这几周发了官方作业，就做官方的，把我的当热身。

两件别做的事。别把第 1 周花在重读 2025 的提示词 PPT 上——2026 秋季跳过提示基础是有原因的，真需要补，自学手册里的两周速通更快。也别把 Maven 付费班叠在这套方案上——两者重合度太高，等于花钱买同样的练习外加一个 deadline。

倒是有一件值得做的事：把 CS146S 和今年秋天并行开的几门 agent 课搭着学，因为它们讲的恰好是 CS146S 刻意跳过的部分（训练和评测 agent 本身）。斯坦福 [CS329Z: Engineering AI Agents](https://cs329z.stanford.edu/)（Diyi Yang，9 月 23 日到 12 月 2 日）大纲公开，但录像只在 Canvas 上。CMU 的 [11-768: AI Agents](https://www.cmu-agents.com/)（Graham Neubig 和 Daniel Fried）是真正往外发视频的那门：截至 9 月 11 日，2026 秋季已有 4 讲上了 YouTube，学期进行中持续更新。斯坦福 [CS329A: Self-Improving AI Agents](https://cs329a.stanford.edu/) 上一轮的 9 讲全部在 Stanford Online 的 YouTube 频道。只有精力搭一门的话，选 CMU 那门——它最接近大家一直在搜的那种"能看的课"。

跑 2025 作业仓库的最小步骤，省得你踩环境坑：Python 3.12（官方 README 用 conda 建环境），`curl` 装 Poetry，仓库根目录 `poetry install --no-interaction`，然后进 `week2`、`week3` 目录按 `assignment.md` 走。国内 pip 源慢的话给 Poetry 配一下镜像，其余没有特殊依赖。

工具方面，Claude Code、Cursor、Codex CLI 三选一都能覆盖全部 10 周；MCP 和 skills 两周的练习在 Claude Code 里最省事，因为课程自己的示例就是围着它写的。
...
你不会损失的是内容。按 2025 年的规律，课堂上放的每一份 PPT几天内都会变成大纲页上的 Google Slides 链接；阅读材料是公开 URL；工具就是你本来就要装的那几个。跟着课程表走、做完练习、合进一个 PR，学期结束时你手里的能力证据，会比 2025 年 12 月大多数注册学生还多——那时候交付物还只是一个单人项目。

## 这篇到此为止

这篇只负责课程表和跟课方案。它刻意不重讲每节课教什么、也不给 2025 的讲座打分，那是[课程总览](/zh/posts/ai/2026-02-24-stanford-cs146s-overview/)和[自学手册](/zh/posts/ai/2026-07-02-cs146s-study-guide/)的活。课程后续公布上课时间、PPT 或 2026 作业分支，我会更新课程表并在文首标注。

三个我没能核实的事实，记在这里：上课的具体时间（公开站点没有）、Maven 课程的价格和秋季班是否存在、30% 开源贡献是否限定在官网列出的合作方项目。如果你是注册学生，知道其中任何一条，评论区开着。
