...
toc = true
tags = ['AGI', 'AI Agent', 'AI Trends', 'AI Agents', 'Long-horizon Agent']
categories = ['AI Guides']
keywords = ['AGI', 'AI Agent', '2026 AI 趋势', '智能体', '长周期Agent', 'AI能力增长']

[[params.faqItems]]
question = "红杉资本说的「2026 就是 AGI」到底在说什么？"
answer = "结论是：长周期智能体（long-horizon agents）已经是功能意义上的 AGI，2026 年是它们的年份。这篇博客发于 2026 年 1 月 14 日，论据是三块拼图已经齐了——2022 年 ChatGPT 带来预训练知识、2024 年底 o1 系列带来推理能力、2026 年 Claude Code 这类编程 Agent 带来迭代能力。他们给创业者的建议是：别等了。"

[[params.faqItems]]
question = "AGI 该怎么定义？红杉给的答案是什么？"
answer = "AGI 就是能把事情搞清楚的能力。红杉明说自己是投资人不是研究者，所以不谈参数量和跑分，只看结果——它能不能把活干完。拆开是三件事：知识、推理、迭代，人和 AI 都需要这三样。几年前他们问顶尖研究者怎么定义 AGI，得到的回答是「每个人都有自己的定义，但看见了就知道」。"

[[params.faqItems]]
question = "31 分钟猎头那个案例具体做了什么？"
answer = "创始人只发了一句话要招 DevRel 负责人，Agent 在 31 分钟后交回了一份只有一个人的名单。过程是：先搜 LinkedIn，发现职位头衔看不出好坏，转去 YouTube 找 50 多个技术大会演讲者按互动数据筛，再到 Twitter 交叉验证留下十几个有真实粉丝的，注意到其中三人近三个月发帖频率下降，最后锁定一位 D 轮公司的 DevRel——公司刚裁了市场部、演讲主题是平台工程、1.4 万粉丝、LinkedIn 两个月没更新。这些步骤没人教过它。"

[[params.faqItems]]
question = "Agent 能力每 7 个月翻一番，这个数据靠谱吗？"
answer = "数据来自 METR 的实测追踪，不是拍脑袋。按这条曲线外推：2026 年能稳定完成约 30 分钟的专家级工作，2028 年一整天，2034 年一整年，2037 年一个世纪。红杉自己也承认 Agent 仍会犯错、会幻觉、会丢上下文、有时自信地走上完全错误的路；但他们强调该看的是改进速率，而不是某个时点的能力值。"

[[params.faqItems]]
question = "「会说话」和「会做事」的 AI 差在哪？"
answer = "差在对话结束之后活还得不得自己干。2023-2024 年的 ChatGPT、AI 写作和编程助手都是能力的延伸，聊完你还要自己动手。红杉预测 2026-2027 年的应用会像同事：从一天用几次变成 7×24 运行，从一个聊天窗口变成多实例并行，用户角色从个人贡献者变成管理一队 Agent，交互方式从聊天变成派任务。定价也要跟着改——按价值和结果收费，不是按 API 调用。"

[[params.faqItems]]
question = "AI 什么都能干了，人还剩什么？"
answer = "指令能力。红杉那三要素（知识、推理、迭代）同样适用于人：竞争不再是谁写代码快，而是谁拆解问题拆得准；不是谁记的知识多，而是谁知道该问什么问题；不是执行速度，而是方向判断。你思考得越严谨，指令就越清晰；指令越清晰，结果就越精确。角色是从个人贡献者变成 Agent 团队的管理者。"
+++
...
- [Claude Code 入门指南](/zh/posts/ai/2026-01-14-claude-code-guide/)
