...
[[params.faqItems]]
question = "功能不好用，该优化还是该删掉？"
answer = "先问该不该存在，再问怎么优化。顺序反了就是勤奋的浪费——我曾花两周优化一个高级筛选功能，调交互、改 UI、加缓存、写文档，上线后使用率几乎为零，因为用户要的根本不是手动筛选而是一键推荐。判断标准三条：过去 30 天使用率低于 5% 考虑删；明天砍掉没人投诉就是没人在乎；不在核心价值链上就可以砍。"

[[params.faqItems]]
question = "删除优先这套思路除了产品还能用在哪？"
answer = "代码、产品、个人三个层面都成立。代码上，与其优化一段难维护的逻辑，不如先问这段逻辑还需要吗；产品上，与其优化低频功能，不如问用户真的需要吗；个人上，与其优化低效习惯，不如问这件事还该不该做。特斯拉早期产线上那批拖慢节奏的机器人，解法不是优化程序而是直接锯下来搬走——如果一个东西的存在本身就是问题，优化它没有意义。"

[[params.faqItems]]
question = "怎么判断一条需求是真需求还是行业惯例？"
answer = "追问到底是谁提的，要有名有姓。用户提的就看数据验证，老板提的就了解背后的真实诉求，答案是「大家都这么做」的大概率可以质疑。不接受法务部说的、行业惯例、一直都是这样这类模糊来源。某制造企业的零件供应商报价 12 万美元说是行业标准价，逼着工程师自己研究后 5000 块就造出来了，差 24 倍——之前没人质疑，只因为那是供应商报的价。"

[[params.faqItems]]
question = "独立开发者最该质疑哪些「理所当然」？"
answer = "脑子里那些没被检验过的默认前提。做产品一定要写 PRD 吗——一个人做的话画个草图够不够？上线前一定要测试完善吗——能不能先发 50% 功能看有没有人用？竞品有的功能我也要有吗——用户选你是因为那个功能吗？做 SaaS 一定要多租户、MVP 一定要有用户系统，这些都不是物理定律。砍掉这些隐形枷锁，MVP 能做得更轻更快。"

[[params.faqItems]]
question = "只看后台数据做决策够吗？"
answer = "不够，数据告诉你发生了什么，不告诉你为什么。我做过一个小工具，后台显示平均使用时长 5 分钟，看着像深度使用；找了几个用户远程观察 15 分钟才发现，那 5 分钟是用户卡在某个步骤反复试错——不是在用产品，是在跟产品较劲。只看数据永远发现不了这个问题。"

[[params.faqItems]]
question = "怎么做用户观察才有效？"
answer = "每月至少一次：找一个真实用户（付费用户优先），远程共享屏幕或录屏，看他完整操作至少 15 分钟，全程不指导不解释，记录他卡住的每一个地方。三个技巧：别问「你觉得怎么样」，用户会客气地说挺好的；关注犹豫——鼠标停下来的地方就是困惑的地方；一段 5 分钟录屏抵得上 50 份问卷。这也是腾讯 10/100/1000 法则的精髓：每月深聊 10 个用户、每周看 100 条反馈、每天关注 1000 条行为数据。"
+++
...
关于 AI 时代如何做减法、如何找到真正值得做的事，可以看 [AI 时代，一个人的 Taste 比以往任何时候都重要](/zh/posts/ai/2026-01-23-taste-matters-in-ai-era/)，里面聊了"品味"为什么是最稀缺的能力。
...
砍掉这些隐形的枷锁，你会发现 MVP 能做得更轻、更快。对于如何用 AI 高效做 MVP，可以参考 [我的 AI 开发工作流：从需求到上线](/zh/posts/ai/2026-01-19-ai-dev-workflow/)。
...
在 AI 时代，这套思维方式尤其重要。当 AI 能帮你高速产出的时候，"做什么"比"怎么做"重要了一百倍。关于这个话题，推荐读 [2026 年 AGI 已经来了：从功能定义到 31 分钟猎头实战](/zh/posts/ai/2026-01-26-agi-is-here/)。
