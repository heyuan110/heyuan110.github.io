...
draft = false
title = 'Claude Code --teammate-mode 详解：让多个 Agent'
description = 'Claude Code Agent Teams 实战：设置 CLAUDE_CODE_EXPERIMENTAL_AGENT_TEAMS=1 即可启用 2026 年 2 月随 Opus 4.6 发布的多...'
toc = true
