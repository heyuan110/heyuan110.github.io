...
draft = false
title = 'Claude Code Teammate Mode: Multi-Agent Setup with tmux'
description = 'Run several Claude agents at once with teammate-mode: split-pane in tmux or iTerm2, mailbox messaging between agents, worktree isolation and token cost control.'
toc = true
