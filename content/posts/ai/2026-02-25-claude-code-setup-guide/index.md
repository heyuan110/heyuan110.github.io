...
keywords = ['how to install claude code', 'claude code setup 2026', 'claude code install', 'claude code tutorial 2026', 'claude code getting started 2026', 'claude code vs code', 'claude code installation guide', 'claude code setup']
