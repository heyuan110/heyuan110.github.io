...
draft = false
title = 'Sub-Agent 架构设计：什么时候该拆子 Agent，Opus/Sonnet'
description = 'Sub-Agent 架构的本质是上下文垃圾回收，不是并行加速器。实测经验：每次 spawn 至少 10000 token 输入才划算，Sonnet 做调度、Opus 做最终生成、Haiku 做扫描的路...'
toc = true
