...
draft = false
title = 'Claude Agent SDK 实战指南：3 行 Python 搭建生产级 A'
description = 'Claude Agent SDK 用 3 行 Python 就能搭出能读写文件、执行命令的 AI Agent——LangChain 同样功能约需 80 行。详解 query() 与 ClaudeSDK...'
toc = true
