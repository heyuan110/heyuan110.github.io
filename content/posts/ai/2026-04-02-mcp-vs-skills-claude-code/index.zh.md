...
draft = false
title = 'MCP、Skills、Hooks 到底有什么区别？Claude Code 三大扩'
description = 'MCP、Skills、Hooks 的区别一文讲透：MCP 连外部服务提供能力，Skill 是教 AI 做事的知识包，Hooks 强制执行硬规则。一个 15 工具的 MCP 服务器常驻占约 1500-3...'
toc = true
...
- [Skill 与 MCP 的区别：两种扩展 AI 能力的方式](/zh/posts/ai/2026-01-06-skillmcp/) — 早期对 Skills 和 MCP 基础概念的梳理
- [Claude Code MCP 配置指南：连接 AI 到任何外部服务](/zh/posts/ai/2026-02-28-claude-code-mcp-setup/) — MCP 服务器安装和自建的实操教程
- [Claude Code Skills 完全指南：创建自定义 SKILL.md 工作流](/zh/posts/ai/2026-02-28-claude-code-skills-guide/) — 从零创建生产级 Skill 的详细指南
- [Claude Code Hooks 2026：完整事件列表 + 即用配置](/zh/posts/ai/2026-02-28-claude-code-hooks-guide/) — 所有 Hook 事件详解，附可直接复制的配置
- [MCP 协议详解：AI 集成的通用标准](/zh/posts/ai/2026-02-20-mcp-protocol-guide/) — MCP 协议架构的完整技术解析
