...
- [ego lite 实测：把你登录好的浏览器交给 Claude Code，token 省了多少](/zh/posts/ai/2026-09-10-ego-lite-browser-review/) — 2026 年 9 月的续篇：ubrowser 许诺的「打包执行 + 只送答案」成本模型，装进了一个带你登录态的真浏览器
