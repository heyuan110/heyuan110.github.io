...
- [Mastering Anthropic Agent SDK Hooks: Intercept & Secure](/posts/ai/2026-09-14-mastering-anthropic-agent-hooks/) -- the same lifecycle events from the Agent SDK side, wired into a security loop
