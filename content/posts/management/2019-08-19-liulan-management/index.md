...
2. **Patterns**: Is this part of a recurring behavior pattern? How does it happen?
3. **System structure**: Does the system itself cause these patterns? Why does it happen?
...
**Good failure** (g): Actively pursued through experimentation — the source of learning.
**Neutral failure** (e, f): Unavoidable — failure is normal.
**Bad failure** (a-d): Preventable — should be minimized.
